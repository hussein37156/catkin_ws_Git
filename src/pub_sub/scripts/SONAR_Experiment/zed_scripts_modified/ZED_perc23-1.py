...
timestamp = datetime.datetime.now().strftime("%Y%m%d_%H%M%S") +str("pyzed")
            ...
            if (timestamp_list[index] > last_ts_list[index]):               
                ...
                if(name_list[index] == 'ZED 16133'):
                    ...
                    if((zed2_left_num_of_instances == 1)and(zed2_right_num_of_instances==1)):
                        if(((int)(zed2_left_result[0].boxes.data[i][5].item()) == 11) and ((int)(zed2_right_result[0].boxes.data[i][5].item()) == 11)): #10 gman     11 bootleger
                            zed2_is_detected = 1
